            ...
            <main className="max-w-6xl mx-auto p-8">
                ...
                <section className="mb-24">
                    <div className="max-w-6xl">
                        <span className="font-optima text-sm tracking-[0.3em] uppercase text-gray-500 block mb-4">
                    ...
                    <div className="classic-rule">
                        <p className="font-caslon text-lg leading-relaxed mb-6">
                ...
                <section className="mb-24">
                    <div className="max-w-6xl">
                        ...
                        <h3 className="font-bodoni text-2xl md:text-3xl italic mb-8">Where Exceptional is Found</h3>
                    </div>
                ...
                <section className="mb-24">
                    <div className="max-w-6xl">
                        ...
                        <div className="mb-8">
                            <span className="font-modern text-4xl md:text-7xl font-thin tracking-tight block">THE</span>
                            <span className="font-modern text-5xl md:text-8xl font-bold tracking-tight">MAGNOLIA</span>
                        </div>
                    </div>
...
export default TypographyWithColumns;