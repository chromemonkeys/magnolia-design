...
const ParallaxDemo = () => {
    ...
    const sections = [
        {
            ...
            subtitle: "WHERE EXCEPTIONAL IS FOUND",
    ...
    return (
        <main className="relative w-full" role="main" aria-label="Magnolia Collection showcase">
            ...
            {/* Splash Section */}
            <section
                className="min-h-screen w-full bg-black relative flex flex-col items-center justify-center"
                role="banner"
            ...
            {sections.map((section, index) => (
                <div key={index} className="relative">
                    ...
                    <section
                        className="min-h-screen w-full bg-white relative flex items-center py-16 md:py-24"
                        role="region"
                    ...
                    >
                        <div className="w-full px-4 sm:px-8 md:px-16 max-w-4xl mx-auto">
                            ...
                            <div className="content-columns">
                                <div className="font-caslon text-base sm:text-lg md:text-xl text-gray-800 leading-relaxed whitespace-pre-line break-words">
                                    {section.content}
                                </div>
                            </div>
                        </div>
